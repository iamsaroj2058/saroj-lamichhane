...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center section-padding overflow-hidden pt-16"
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "1.5s" }}></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-secondary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "3s" }}></div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-lg">
                ...
                through thoughtful UI/UX design and clean, scalable code.
              </p>
              ...
              <div className="relative w-full max-w-md aspect-square">
                ...
                <div className="relative w-full h-full glass-card rounded-3xl p-8 flex items-center justify-center animate-float">
                  <div className="grid grid-cols-3 gap-6 w-full">
                    ...
                    <div className="p-4 bg-gradient-to-br from-accent/20 to-primary/10 rounded-xl hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-accent/50 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                      <Palette className="text-accent" size={40} />
                    </div>
                    <div className="p-4 bg-gradient-to-br from-primary/20 to-accent/10 rounded-xl hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-primary/50 animate-fade-in" style={{ animationDelay: "0.4s" }}>
                      <Layers className="text-primary" size={40} />
                    </div>
                    <div className="p-4 bg-gradient-to-br from-secondary/20 to-primary/10 rounded-xl hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/50 animate-fade-in" style={{ animationDelay: "0.6s" }}>
